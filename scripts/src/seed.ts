...
async function seed() {
  const { usersTable, dealsTable, contractsTable, timelineTable, transferRequestsTable, templatesTable } = schema;

  // Seed contract templates (one or more per deal type)
  await db.insert(templatesTable).values([
    {
      name: "عقد عربون شراء عقار",
      type: "real_estate",
    ...
    },
    {
      ...
      refundConditions: "يُسترجع العربون كاملاً في حال رسوب المركبة في الفحص الفني، أو اختلاف المواصفات عن المعلن، أو تراجع البائع.",
      forfeitureConditions: "يُصادر العربون لصالح البائع إذا انسحب المشتري بعد اجتياز المركبة الفحص ومطابقتها للمواصفات.",
    },
    {
      name: "عقد عربون بيع نشاط تجاري",
      type: "business",
      description: "قالب لحجز نشاط تجاري قائم (محل/مؤسسة) بعربون يشمل نقل الترخيص والموجودات.",
      terms: "يدفع المشتري عربوناً لحجز النشاط التجاري بما يشمله من ترخيص وموجودات وعقود إيجار سارية. يلتزم البائع بتقديم القوائم المالية والمستندات الرسمية للمراجعة.",
      refundConditions: "يُسترجع العربون كاملاً إذا تبيّن عدم صحة البيانات المالية أو وجود التزامات أو ديون غير معلنة على النشاط.",
      forfeitureConditions: "يُصادر العربون إذا تراجع المشتري بعد اطلاعه على المستندات وموافقته عليها دون عذر مشروع.",
    },
    {
      name: "عقد عربون عام",
      type: "other",
      description: "قالب مرن لأي صفقة تتطلب عربوناً لضمان الجدية بين الطرفين وفق شروط مخصصة.",
      terms: "يتفق الطرفان على دفع مبلغ عربون لضمان جدية إتمام الصفقة محل الاتفاق. تُحدد التفاصيل والمدة والقيمة داخل العقد ويُخصم العربون من القيمة الإجمالية عند الإتمام.",
      refundConditions: "يُسترجع العربون كاملاً في حال إخلال الطرف الآخر بالتزاماته أو الاتفاق على الفسخ الودّي.",
      forfeitureConditions: "يُصادر العربون لصالح الطرف المتضرر في حال انسحاب الطرف الدافع دون عذر مشروع.",
    },
  ]);
