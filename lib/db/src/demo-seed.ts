  ...
  await db.insert(templatesTable).values([
    {
      ...
      refundConditions:
        "يحق للمشتري الانسحاب من الصفقة واسترداد كامل مبلغ العربون في أي وقت قبل إتمام الصفقة، وكذلك عند تراجع البائع أو ظهور عيب جوهري.",
      forfeitureConditions:
        "لا يُصادر مبلغ العربون على المشتري عند انسحابه؛ يبقى المبلغ قابلاً للاسترداد بالكامل في جميع الأحوال.",
    },
    {
